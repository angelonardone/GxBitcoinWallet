...
namespace GeneXus.Programs.gxexplorer
{
	...
	public class SdtGxExplorer_services_TxoutFromAddresses_Transaction_Used : GxUserType
	{
		...
		public override void ToJSON(bool includeState)
		{
			...
			AddObjectProperty("UsedN", gxTpr_Usedn, false);
		...
		public GXBaseCollection<GeneXus.Programs.gxexplorer.SdtGxExplorer_services_TxoutFromAddresses_Transaction_Used_UsedTo_Item> gxTpr_Usedto_GXBaseCollection
		{
			get {
				if ( gxTv_SdtGxExplorer_services_TxoutFromAddresses_Transaction_Used_Usedto == null )
				{
					gxTv_SdtGxExplorer_services_TxoutFromAddresses_Transaction_Used_Usedto = new GXBaseCollection<GeneXus.Programs.gxexplorer.SdtGxExplorer_services_TxoutFromAddresses_Transaction_Used_UsedTo_Item>( context, "GxExplorer_services_TxoutFromAddresses_Transaction_Used_UsedTo_Item", "");
				}
		...
		[XmlIgnore]
		public GXBaseCollection<GeneXus.Programs.gxexplorer.SdtGxExplorer_services_TxoutFromAddresses_Transaction_Used_UsedTo_Item> gxTpr_Usedto
		{
			get {
				if ( gxTv_SdtGxExplorer_services_TxoutFromAddresses_Transaction_Used_Usedto == null )
				{
		...
		protected GXBaseCollection<GeneXus.Programs.gxexplorer.SdtGxExplorer_services_TxoutFromAddresses_Transaction_Used_UsedTo_Item> gxTv_SdtGxExplorer_services_TxoutFromAddresses_Transaction_Used_Usedto = null;  
	...
	public class SdtGxExplorer_services_TxoutFromAddresses_Transaction_Used_RESTInterface : GxGenericCollectionItem<SdtGxExplorer_services_TxoutFromAddresses_Transaction_Used>, System.Web.SessionState.IRequiresSessionState
	{
		...
		{
			get { 
				return StringUtil.LTrim( StringUtil.Str( (decimal) sdt.gxTpr_Usedn, 10, 0));
		...
		{
			get { 
				return DateTimeUtil.TToC2( sdt.gxTpr_Useddatetime);

			}
			set { 
				sdt.gxTpr_Useddatetime = DateTimeUtil.CToT2(value);
			}
		}

		[DataMember(Name="UsedTo", Order=3, EmitDefaultValue=false)]
		public  GxGenericCollection<GeneXus.Programs.gxexplorer.SdtGxExplorer_services_TxoutFromAddresses_Transaction_Used_UsedTo_Item_RESTInterface> gxTpr_Usedto
		{
			get { 
				if (sdt.ShouldSerializegxTpr_Usedto_GXBaseCollection_Json())
					return new GxGenericCollection<GeneXus.Programs.gxexplorer.SdtGxExplorer_services_TxoutFromAddresses_Transaction_Used_UsedTo_Item_RESTInterface>(sdt.gxTpr_Usedto);
				else
					return null;
