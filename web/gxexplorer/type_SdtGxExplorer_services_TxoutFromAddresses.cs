...
namespace GeneXus.Programs.gxexplorer
{
	...
	public class SdtGxExplorer_services_TxoutFromAddresses : GxUserType
	{
		...
		public GXBaseCollection<GeneXus.Programs.gxexplorer.SdtGxExplorer_services_TxoutFromAddresses_Transaction_TransactionItem> gxTpr_Transaction_GXBaseCollection
		{
			get {
				if ( gxTv_SdtGxExplorer_services_TxoutFromAddresses_Transaction == null )
				{
					gxTv_SdtGxExplorer_services_TxoutFromAddresses_Transaction = new GXBaseCollection<GeneXus.Programs.gxexplorer.SdtGxExplorer_services_TxoutFromAddresses_Transaction_TransactionItem>( context, "GxExplorer_services_TxoutFromAddresses_Transaction_TransactionItem", "");
				}
		...
		[XmlIgnore]
		public GXBaseCollection<GeneXus.Programs.gxexplorer.SdtGxExplorer_services_TxoutFromAddresses_Transaction_TransactionItem> gxTpr_Transaction
		{
			get {
				if ( gxTv_SdtGxExplorer_services_TxoutFromAddresses_Transaction == null )
				{
		...
		protected GXBaseCollection<GeneXus.Programs.gxexplorer.SdtGxExplorer_services_TxoutFromAddresses_Transaction_TransactionItem> gxTv_SdtGxExplorer_services_TxoutFromAddresses_Transaction = null;  
	...
	public class SdtGxExplorer_services_TxoutFromAddresses_RESTInterface : GxGenericCollectionItem<SdtGxExplorer_services_TxoutFromAddresses>, System.Web.SessionState.IRequiresSessionState
	{
		...
		public  GxGenericCollection<GeneXus.Programs.gxexplorer.SdtGxExplorer_services_TxoutFromAddresses_Transaction_TransactionItem_RESTInterface> gxTpr_Transaction
		{
			get { 
				if (sdt.ShouldSerializegxTpr_Transaction_GXBaseCollection_Json())
					return new GxGenericCollection<GeneXus.Programs.gxexplorer.SdtGxExplorer_services_TxoutFromAddresses_Transaction_TransactionItem_RESTInterface>(sdt.gxTpr_Transaction);
				else
					return null;
