...
namespace GeneXus.Programs.gxexplorer {
   public class gxexplorerservicestansactionsfromaddressestransactionspost : GXProcedure
   {
      public gxexplorerservicestansactionsfromaddressestransactionspost( )
      {
      ...
      public gxexplorerservicestansactionsfromaddressestransactionspost( IGxContext context )
      {
      ...
      public void execute( GXProperties aP0_ServerUrlTemplatingVar ,
                           GeneXus.Programs.gxexplorer.SdtTransactions__postInput aP1_body ,
                           out GeneXus.Programs.gxexplorer.SdtGxExplorer_services_TxoutFromAddresses aP2_GxExplorer_services_TxoutFromAddressesOUT ,
                           ...
                           out bool aP4_IsSuccess )
      {
         ...
         this.GxExplorer_services_TxoutFromAddressesOUT = new GeneXus.Programs.gxexplorer.SdtGxExplorer_services_TxoutFromAddresses(context) ;
      ...
      public void executeSubmit( GXProperties aP0_ServerUrlTemplatingVar ,
                                 ...
                                 out bool aP4_IsSuccess )
      {
         gxexplorerservicestansactionsfromaddressestransactionspost objgxexplorerservicestansactionsfromaddressestransactionspost;
         objgxexplorerservicestansactionsfromaddressestransactionspost = new gxexplorerservicestansactionsfromaddressestransactionspost();
         objgxexplorerservicestansactionsfromaddressestransactionspost.AV10ServerUrlTemplatingVar = aP0_ServerUrlTemplatingVar;
         objgxexplorerservicestansactionsfromaddressestransactionspost.AV8body = aP1_body;
         objgxexplorerservicestansactionsfromaddressestransactionspost.GxExplorer_services_TxoutFromAddressesOUT = new GeneXus.Programs.gxexplorer.SdtGxExplorer_services_TxoutFromAddresses(context) ;
         objgxexplorerservicestansactionsfromaddressestransactionspost.AV20HttpMessage = new GeneXus.Utils.SdtMessages_Message(context) ;
         objgxexplorerservicestansactionsfromaddressestransactionspost.AV19IsSuccess = false ;
         objgxexplorerservicestansactionsfromaddressestransactionspost.context.SetSubmitInitialConfig(context);
         objgxexplorerservicestansactionsfromaddressestransactionspost.initialize();
         Submit( executePrivateCatch,objgxexplorerservicestansactionsfromaddressestransactionspost);
         aP2_GxExplorer_services_TxoutFromAddressesOUT=this.GxExplorer_services_TxoutFromAddressesOUT;
         aP3_HttpMessage=this.AV20HttpMessage;
         aP4_IsSuccess=this.AV19IsSuccess;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((gxexplorerservicestansactionsfromaddressestransactionspost)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         AV11localVarPath = "/Transactions";
         GXt_SdtApiResponse1 = AV14localVarResponse;
         GXt_char2 = "";
         GXt_char3 = "";
         new GeneXus.Programs.gxexplorer.apibaseurl(context ).execute(  StringUtil.Format( "%1 - %2", StringUtil.Trim( AV11localVarPath), "POST", "", "", "", "", "", "", ""), out  GXt_char3) ;
      ...
      private GeneXus.Programs.gxexplorer.SdtGxExplorer_services_TxoutFromAddresses aP2_GxExplorer_services_TxoutFromAddressesOUT ;
      ...
      private GeneXus.Programs.gxexplorer.SdtTransactions__postInput AV8body ;
