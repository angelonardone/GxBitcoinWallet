...
namespace GeneXus.Programs.gxexplorer
{
	...
	public class SdtGxExplorer_services_TxoutFromAddresses_Transaction_TransactionItem : GxUserType
	{
		...
		public GeneXus.Programs.gxexplorer.SdtGxExplorer_services_TxoutFromAddresses_Transaction_Used gxTpr_Used
		{
			get {
				if ( gxTv_SdtGxExplorer_services_TxoutFromAddresses_Transaction_TransactionItem_Used == null )
				{
					gxTv_SdtGxExplorer_services_TxoutFromAddresses_Transaction_TransactionItem_Used = new GeneXus.Programs.gxexplorer.SdtGxExplorer_services_TxoutFromAddresses_Transaction_Used(context);
				}
		...
		protected GeneXus.Programs.gxexplorer.SdtGxExplorer_services_TxoutFromAddresses_Transaction_Used gxTv_SdtGxExplorer_services_TxoutFromAddresses_Transaction_TransactionItem_Used = null;
	...
	public class SdtGxExplorer_services_TxoutFromAddresses_Transaction_TransactionItem_RESTInterface : GxGenericCollectionItem<SdtGxExplorer_services_TxoutFromAddresses_Transaction_TransactionItem>, System.Web.SessionState.IRequiresSessionState
	{
		...
		{
			get { 
				return DateTimeUtil.TToC2( sdt.gxTpr_Datetime);

			}
			set { 
				sdt.gxTpr_Datetime = DateTimeUtil.CToT2(value);
			}
		}

		[DataMember(Name="Used", Order=5, EmitDefaultValue=false)]
		public GeneXus.Programs.gxexplorer.SdtGxExplorer_services_TxoutFromAddresses_Transaction_Used_RESTInterface gxTpr_Used
		{
			get { 
				if (sdt.ShouldSerializegxTpr_Used_Json())
					return new GeneXus.Programs.gxexplorer.SdtGxExplorer_services_TxoutFromAddresses_Transaction_Used_RESTInterface(sdt.gxTpr_Used);
				else
					return null;
