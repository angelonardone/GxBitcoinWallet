...
namespace GeneXus.Programs.nbitcoin {
   public class createextkey : GXProcedure
   {
      ...
      public void executeSubmit( GeneXus.Programs.nbitcoin.SdtExtKeyCreate aP0_extKeyCreate ,
                                 ...
                                 out string aP3_error )
      {
         createextkey objcreateextkey;
         objcreateextkey = new createextkey();
         objcreateextkey.AV11extKeyCreate = aP0_extKeyCreate;
         objcreateextkey.AV16password = aP1_password;
         objcreateextkey.AV12keyInfo = new GeneXus.Programs.nbitcoin.SdtExtKeyInfo(context) ;
         objcreateextkey.AV9error = "" ;
         objcreateextkey.context.SetSubmitInitialConfig(context);
         objcreateextkey.initialize();
         Submit( executePrivateCatch,objcreateextkey);
         aP2_keyInfo=this.AV12keyInfo;
         aP3_error=this.AV9error;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((createextkey)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV9error)) )
         {
            ...
            /* User Code */
             	AV18val = val;
            AV12keyInfo.gxTpr_Extended.gxTpr_Depth = (short)(NumberUtil.Val( AV18val, "."));
            /* User Code */
             val = privateExtKey.Child.ToString();
            /* User Code */
             	AV18val = val;
            AV12keyInfo.gxTpr_Extended.gxTpr_Child = (long)(NumberUtil.Val( AV18val, "."));
            /* User Code */
