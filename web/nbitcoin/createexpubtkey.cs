...
namespace GeneXus.Programs.nbitcoin {
   public class createexpubtkey : GXProcedure
   {
      ...
      public void executeSubmit( string aP0_ExtendedPublicKey ,
                                 ...
                                 out string aP4_error )
      {
         createexpubtkey objcreateexpubtkey;
         objcreateexpubtkey = new createexpubtkey();
         objcreateexpubtkey.AV9ExtendedPublicKey = aP0_ExtendedPublicKey;
         objcreateexpubtkey.AV12networkType = aP1_networkType;
         objcreateexpubtkey.AV11keyPath = aP2_keyPath;
         objcreateexpubtkey.AV10keyInfo = new GeneXus.Programs.nbitcoin.SdtExtPubKeyInfo(context) ;
         objcreateexpubtkey.AV8error = "" ;
         objcreateexpubtkey.context.SetSubmitInitialConfig(context);
         objcreateexpubtkey.initialize();
         Submit( executePrivateCatch,objcreateexpubtkey);
         aP3_keyInfo=this.AV10keyInfo;
         aP4_error=this.AV8error;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((createexpubtkey)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV8error)) )
         {
            ...
            /* User Code */
             	AV13val = val;
            AV10keyInfo.gxTpr_Depth = (short)(NumberUtil.Val( AV13val, "."));
            /* User Code */
             val = masterPubKey.Child.ToString();
            /* User Code */
             	AV13val = val;
            AV10keyInfo.gxTpr_Child = (long)(NumberUtil.Val( AV13val, "."));
            /* User Code */
