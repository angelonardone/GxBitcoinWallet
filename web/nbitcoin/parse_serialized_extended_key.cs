...
namespace GeneXus.Programs.nbitcoin {
   public class parse_serialized_extended_key : GXProcedure
   {
      ...
      public void executeSubmit( string aP0_in_extended_key ,
                                 ...
                                 out string aP4_error )
      {
         parse_serialized_extended_key objparse_serialized_extended_key;
         objparse_serialized_extended_key = new parse_serialized_extended_key();
         objparse_serialized_extended_key.AV10in_extended_key = aP0_in_extended_key;
         objparse_serialized_extended_key.AV12out_extended_key = "" ;
         objparse_serialized_extended_key.AV11networkType = "" ;
         objparse_serialized_extended_key.AV9extendedKeyType = "" ;
         objparse_serialized_extended_key.AV8error = "" ;
         objparse_serialized_extended_key.context.SetSubmitInitialConfig(context);
         objparse_serialized_extended_key.initialize();
         Submit( executePrivateCatch,objparse_serialized_extended_key);
         aP1_out_extended_key=this.AV12out_extended_key;
         aP2_networkType=this.AV11networkType;
         aP3_extendedKeyType=this.AV9extendedKeyType;
         aP4_error=this.AV8error;
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((parse_serialized_extended_key)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
