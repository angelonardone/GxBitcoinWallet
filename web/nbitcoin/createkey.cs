...
namespace GeneXus.Programs.nbitcoin {
   public class createkey : GXProcedure
   {
      ...
      public void executeSubmit( GeneXus.Programs.nbitcoin.SdtKeyCreate aP0_keyCreate ,
                                 ...
                                 out string aP3_error )
      {
         createkey objcreatekey;
         objcreatekey = new createkey();
         objcreatekey.AV10keyCreate = aP0_keyCreate;
         objcreatekey.AV12password = aP1_password;
         objcreatekey.AV11keyInfo = new GeneXus.Programs.nbitcoin.SdtKeyInfo(context) ;
         objcreatekey.AV9error = "" ;
         objcreatekey.context.SetSubmitInitialConfig(context);
         objcreatekey.initialize();
         Submit( executePrivateCatch,objcreatekey);
         aP2_keyInfo=this.AV11keyInfo;
         aP3_error=this.AV9error;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((createkey)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
