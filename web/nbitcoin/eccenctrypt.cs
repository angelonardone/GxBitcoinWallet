...
namespace GeneXus.Programs.nbitcoin {
   public class eccenctrypt : GXProcedure
   {
      ...
      public void executeSubmit( string aP0_pubKey ,
                                 ...
                                 out string aP3_error )
      {
         eccenctrypt objeccenctrypt;
         objeccenctrypt = new eccenctrypt();
         objeccenctrypt.AV11pubKey = aP0_pubKey;
         objeccenctrypt.AV10clearText = aP1_clearText;
         objeccenctrypt.AV8cypherText = "" ;
         objeccenctrypt.AV9error = "" ;
         objeccenctrypt.context.SetSubmitInitialConfig(context);
         objeccenctrypt.initialize();
         Submit( executePrivateCatch,objeccenctrypt);
         aP2_cypherText=this.AV8cypherText;
         aP3_error=this.AV9error;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((eccenctrypt)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
