...
namespace GeneXus.Programs.wallet {
   public class notes : GXWebComponent
   {
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 11), "'OPEN NOTE'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 14), "GRIDNOTES.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 11), "'OPEN NOTE'") == 0 ) )
                           {
                              ...
                              AV9GXV1 = nGXsfl_9_idx;
                              if ( ( AV6notes.Count >= AV9GXV1 ) && ( AV9GXV1 > 0 ) )
                              {
                                 AV6notes.CurrentItem = ((GeneXus.Programs.wallet.SdtNote)AV6notes.Item(AV9GXV1));
                              }
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
      ...
      {
         AV9GXV1 = nGXsfl_9_idx;
         if ( ( AV9GXV1 > 0 ) && ( AV6notes.Count >= AV9GXV1 ) )
         {
            AV6notes.CurrentItem = ((GeneXus.Programs.wallet.SdtNote)AV6notes.Item(AV9GXV1));
         }
         /* 'Open Note' Routine */
      ...
      protected void sendrow_92( )
      {
         ...
         GridnotesRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavCtldescription_Internalname,StringUtil.RTrim( ((GeneXus.Programs.wallet.SdtNote)AV6notes.Item(AV9GXV1)).gxTpr_Description),(string)"",(string)"","'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'OPEN NOTE\\'."+sGXsfl_9_idx+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavCtldescription_Jsonclick,(short)5,(string)"Attribute",(string)"",(string)ROClassString,(string)"",(string)"",(short)-1,(int)edtavCtldescription_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)20,(short)0,(short)0,(short)9,(short)1,(short)-1,(short)-1,(bool)true,(string)"",(string)"left",(bool)true,(string)""});
         /* Subfile cell */
         if ( GridnotesContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute";
         GridnotesRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavCtlcreated_Internalname,context.localUtil.TToC( ((GeneXus.Programs.wallet.SdtNote)AV6notes.Item(AV9GXV1)).gxTpr_Created, 10, 8, 1, 2, "/", ":", " "),context.localUtil.Format( ((GeneXus.Programs.wallet.SdtNote)AV6notes.Item(AV9GXV1)).gxTpr_Created, "99/99/99 99:99"),(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavCtlcreated_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"",(string)"",(short)-1,(int)edtavCtlcreated_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)17,(short)0,(short)0,(short)9,(short)1,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRIDNOTES_nFirstRecordOnPage'},{av:'GRIDNOTES_nEOF'},{av:'AV6notes',fld:'vNOTES',grid:9,pic:''},{av:'nGXsfl_9_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:9},{av:'nRC_GXsfl_9',ctrl:'GRIDNOTES',prop:'GridRC',grid:9},{av:'sPrefix'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'CREATE A NEW NOTE'","{handler:'E110B2',iparms:[{av:'GRIDNOTES_nFirstRecordOnPage'},{av:'GRIDNOTES_nEOF'},{av:'AV6notes',fld:'vNOTES',grid:9,pic:''},{av:'nGXsfl_9_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:9},{av:'nRC_GXsfl_9',ctrl:'GRIDNOTES',prop:'GridRC',grid:9},{av:'sPrefix'}]");
         ...
         setEventMetadata("'OPEN NOTE'","{handler:'E140B2',iparms:[{av:'GRIDNOTES_nFirstRecordOnPage'},{av:'GRIDNOTES_nEOF'},{av:'AV6notes',fld:'vNOTES',grid:9,pic:''},{av:'nGXsfl_9_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:9},{av:'nRC_GXsfl_9',ctrl:'GRIDNOTES',prop:'GridRC',grid:9},{av:'sPrefix'}]");
         ...
         setEventMetadata("GLOBALEVENTS.DONEWITHNOTES","{handler:'E120B2',iparms:[{av:'GRIDNOTES_nFirstRecordOnPage'},{av:'GRIDNOTES_nEOF'},{av:'AV6notes',fld:'vNOTES',grid:9,pic:''},{av:'nGXsfl_9_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:9},{av:'nRC_GXsfl_9',ctrl:'GRIDNOTES',prop:'GridRC',grid:9},{av:'sPrefix'}]");
         setEventMetadata("GLOBALEVENTS.DONEWITHNOTES",",oparms:[{av:'subGridnotes_Visible',ctrl:'GRIDNOTES',prop:'Visible'},{ctrl:'CREATEANEWNOTE',prop:'Visible'},{ctrl:'COMPNEWNOTE',prop:'Visible'},{av:'AV6notes',fld:'vNOTES',grid:9,pic:''},{av:'nGXsfl_9_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:9},{av:'GRIDNOTES_nFirstRecordOnPage'},{av:'nRC_GXsfl_9',ctrl:'GRIDNOTES',prop:'GridRC',grid:9}]}");
