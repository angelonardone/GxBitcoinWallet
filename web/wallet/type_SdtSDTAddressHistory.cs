...
namespace GeneXus.Programs.wallet
{
	...
	public class SdtSDTAddressHistory_RESTInterface : GxGenericCollectionItem<SdtSDTAddressHistory>, System.Web.SessionState.IRequiresSessionState
	{
		...
		{
			get { 
				return DateTimeUtil.TToC2( sdt.gxTpr_Receiveddatetime);

			}
			set { 
				sdt.gxTpr_Receiveddatetime = DateTimeUtil.CToT2(value);
			}
		}
		...
		[DataMember(Name="ReceivedAmount", Order=2)]
		...
		[DataMember(Name="ReceivedTransactionId", Order=3)]
		public  string gxTpr_Receivedtransactionid
		{
			get { 
		...
		[DataMember(Name="RecivedN", Order=4)]
		...
		{
			get { 
				return DateTimeUtil.TToC2( sdt.gxTpr_Sentdatetime);

			}
			set { 
				sdt.gxTpr_Sentdatetime = DateTimeUtil.CToT2(value);
			}
		}
