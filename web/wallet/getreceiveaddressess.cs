...
namespace GeneXus.Programs.wallet {
   public class getreceiveaddressess : GXProcedure
   {
      ...
      {
         getreceiveaddressess objgetreceiveaddressess;
         objgetreceiveaddressess = new getreceiveaddressess();
         objgetreceiveaddressess.AV10sdt_ReturnAddresses = new GXBaseCollection<GeneXus.Programs.wallet.SdtSDT_ReturnAddresses_SDT_ReturnAddressesItem>( context, "SDT_ReturnAddressesItem", "GxBitcoinWallet") ;
         objgetreceiveaddressess.context.SetSubmitInitialConfig(context);
         objgetreceiveaddressess.initialize();
         Submit( executePrivateCatch,objgetreceiveaddressess);
         aP0_sdt_ReturnAddresses=this.AV10sdt_ReturnAddresses;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((getreceiveaddressess)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
