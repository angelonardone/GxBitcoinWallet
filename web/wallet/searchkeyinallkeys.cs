...
namespace GeneXus.Programs.wallet {
   public class searchkeyinallkeys : GXProcedure
   {
      ...
      public void executeSubmit( string aP0_address ,
                                 ...
                                 out bool aP3_found )
      {
         searchkeyinallkeys objsearchkeyinallkeys;
         objsearchkeyinallkeys = new searchkeyinallkeys();
         objsearchkeyinallkeys.AV10address = aP0_address;
         objsearchkeyinallkeys.AV8allKeyInfo = aP1_allKeyInfo;
         objsearchkeyinallkeys.AV9oneKeyInfo = new GeneXus.Programs.nbitcoin.SdtKeyInfo(context) ;
         objsearchkeyinallkeys.AV11found = false ;
         objsearchkeyinallkeys.context.SetSubmitInitialConfig(context);
         objsearchkeyinallkeys.initialize();
         Submit( executePrivateCatch,objsearchkeyinallkeys);
         aP2_oneKeyInfo=this.AV9oneKeyInfo;
         aP3_found=this.AV11found;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((searchkeyinallkeys)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         AV11found = false;
         AV14GXV1 = 1;
         while ( AV14GXV1 <= AV8allKeyInfo.Count )
         {
            AV9oneKeyInfo = ((GeneXus.Programs.nbitcoin.SdtKeyInfo)AV8allKeyInfo.Item(AV14GXV1));
