   ...
   public class showextendedkey : GXDataArea
   {
      ...
      protected void WB0K0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtavMasterpublickey_Internalname+"\"", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtavCtlparentfingerprint_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtavCtldepth_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavCtldepth_Internalname, "Depth", "col-sm-3 AttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtavCtldepth_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV5extKeyInfo.gxTpr_Extended.gxTpr_Depth), 4, 0, ".", "")), StringUtil.LTrim( ((edtavCtldepth_Enabled!=0) ? context.localUtil.Format( (decimal)(AV5extKeyInfo.gxTpr_Extended.gxTpr_Depth), "ZZZ9") : context.localUtil.Format( (decimal)(AV5extKeyInfo.gxTpr_Extended.gxTpr_Depth), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCtldepth_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavCtldepth_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, false, "", "right", false, "", "HLP_Wallet\\ShowExtendedKey.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtavCtlchild_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavCtlchild_Internalname, "Child", "col-sm-3 AttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtavCtlchild_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV5extKeyInfo.gxTpr_Extended.gxTpr_Child), 10, 0, ".", "")), StringUtil.LTrim( ((edtavCtlchild_Enabled!=0) ? context.localUtil.Format( (decimal)(AV5extKeyInfo.gxTpr_Extended.gxTpr_Child), "ZZZZZZZZZ9") : context.localUtil.Format( (decimal)(AV5extKeyInfo.gxTpr_Extended.gxTpr_Child), "ZZZZZZZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCtlchild_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavCtlchild_Enabled, 0, "text", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, false, "", "right", false, "", "HLP_Wallet\\ShowExtendedKey.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+chkavCtlishardended_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtavMasterprivatekey_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
