...
namespace GeneXus.Programs.wallet {
   public class readnote : GXProcedure
   {
      ...
      public void executeSubmit( string aP0_noteFile_source ,
                                 out GeneXus.Programs.wallet.SdtNote aP1_note )
      {
         readnote objreadnote;
         objreadnote = new readnote();
         objreadnote.AV12noteFile_source = aP0_noteFile_source;
         objreadnote.AV10note = new GeneXus.Programs.wallet.SdtNote(context) ;
         objreadnote.context.SetSubmitInitialConfig(context);
         objreadnote.initialize();
         Submit( executePrivateCatch,objreadnote);
         aP1_note=this.AV10note;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((readnote)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
