...
namespace GeneXus.Programs.wallet {
   public class readallwallets : GXProcedure
   {
      ...
      {
         readallwallets objreadallwallets;
         objreadallwallets = new readallwallets();
         objreadallwallets.AV11wallets = new GXBaseCollection<GeneXus.Programs.wallet.SdtWallet>( context, "Wallet", "GxBitcoinWallet") ;
         objreadallwallets.context.SetSubmitInitialConfig(context);
         objreadallwallets.initialize();
         Submit( executePrivateCatch,objreadallwallets);
         aP0_wallets=this.AV11wallets;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((readallwallets)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         {
            AV17GXV2 = 1;
            AV16GXV1 = AV9directory.GetDirectories();
            while ( AV17GXV2 <= AV16GXV1.ItemCount )
            {
               AV12walletDirectory = AV16GXV1.Item(AV17GXV2);
               AV19GXV4 = 1;
               AV18GXV3 = AV12walletDirectory.GetFiles("*.json");
               while ( AV19GXV4 <= AV18GXV3.ItemCount )
               {
                  AV8auxFile = AV18GXV3.Item(AV19GXV4);
                  GXt_boolean1 = false;
      ...
      public override void initialize( )
      {
         ...
         AV16GXV1 = new GxDirectoryCollection();
         AV12walletDirectory = new GxDirectory(context.GetPhysicalPath());
         AV18GXV3 = new GxFileCollection();
      ...
      private GxFileCollection AV18GXV3 ;
      private GxDirectoryCollection AV16GXV1 ;
