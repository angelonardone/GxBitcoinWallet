...
namespace GeneXus.Programs.wallet {
   public class showkeydetail : GXDataArea
   {
      public showkeydetail( )
      {
      ...
      public showkeydetail( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2022102112335924", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      {
         return "Wallet.ShowKeyDetail" ;
      }

      public override string GetPgmdesc( )
      {
         return "Show Key Detail" ;
      }
      ...
      protected void START0A2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Show Key Detail", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2022102112335936", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wallet/showkeydetail.js", "?2022102112335936", false, true);
         }
