...
namespace GeneXus.Programs.wallet {
   public class readwallet : GXProcedure
   {
      ...
      public void executeSubmit( string aP0_walletFile_source ,
                                 out GeneXus.Programs.wallet.SdtWallet aP1_wallet )
      {
         readwallet objreadwallet;
         objreadwallet = new readwallet();
         objreadwallet.AV12walletFile_source = aP0_walletFile_source;
         objreadwallet.AV10wallet = new GeneXus.Programs.wallet.SdtWallet(context) ;
         objreadwallet.context.SetSubmitInitialConfig(context);
         objreadwallet.initialize();
         Submit( executePrivateCatch,objreadwallet);
         aP1_wallet=this.AV10wallet;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((readwallet)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
