   ...
   public class wallets : GXDataArea
   {
      ...
      protected void WB070( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttRestorewallet_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(11), 2, 0)+","+"null"+");", "Restore Wallet", bttRestorewallet_Jsonclick, 7, "Restore Wallet", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e11071_client"+"'", TempTags, "", 2, "HLP_Wallet\\Wallets.htm");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttCreateanewwallet_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(11), 2, 0)+","+"null"+");", "Create a new Wallet", bttCreateanewwallet_Jsonclick, 7, "Create a new Wallet", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e12071_client"+"'", TempTags, "", 2, "HLP_Wallet\\Wallets.htm");
            GxWebStd.gx_div_end( context, "Right", "top", "div");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2022121113184698", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wallet/wallets.js", "?2022121113184698", false, true);
      ...
      protected void sendrow_112( )
      {
         ...
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavCtlwalletname_Internalname,StringUtil.RTrim( ((GeneXus.Programs.wallet.SdtWallet)AV6wallets.Item(AV10GXV1)).gxTpr_Walletname),(string)"",(string)"","'"+""+"'"+",false,"+"'"+"E\\'OPEN SELECTED WALLET\\'."+sGXsfl_11_idx+"'",(string)edtavCtlwalletname_Link,(string)"",(string)"",(string)"",(string)edtavCtlwalletname_Jsonclick,(short)5,(string)"Attribute",(string)"",(string)ROClassString,(string)"",(string)"",(short)-1,(int)edtavCtlwalletname_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)200,(short)0,(short)0,(short)11,(short)1,(short)-1,(short)-1,(bool)true,(string)"",(string)"left",(bool)true,(string)""});
         /* Subfile cell */
         if ( Grid1Container.GetWrapped() == 1 )
         {
            context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         if ( ( cmbavCtlnetworktype.ItemCount == 0 ) && isAjaxCallMode( ) )
         {
            ...
            cmbavCtlnetworktype.addItem("RegTest", "Reg Test", 0);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'AV6wallets',fld:'vWALLETS',grid:11,pic:'',hsh:true},{av:'nGXsfl_11_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:11},{av:'nRC_GXsfl_11',ctrl:'GRID1',prop:'GridRC',grid:11}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'OPEN SELECTED WALLET'","{handler:'E14072',iparms:[{av:'AV6wallets',fld:'vWALLETS',grid:11,pic:'',hsh:true},{av:'nGXsfl_11_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:11},{av:'GRID1_nFirstRecordOnPage'},{av:'nRC_GXsfl_11',ctrl:'GRID1',prop:'GridRC',grid:11}]");
         setEventMetadata("'OPEN SELECTED WALLET'",",oparms:[]}");
         setEventMetadata("'CREATE A NEW WALLET'","{handler:'E12071',iparms:[]");
         setEventMetadata("'CREATE A NEW WALLET'",",oparms:[]}");
         setEventMetadata("'RESTORE WALLET'","{handler:'E11071',iparms:[]");
         setEventMetadata("'RESTORE WALLET'",",oparms:[]}");
