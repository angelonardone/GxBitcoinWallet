   ...
   public class sendcoins : GXDataArea
   {
      ...
      protected void WB0O0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavTotalbalance_Internalname, StringUtil.LTrim( StringUtil.NToC( AV6totalBalance, 16, 8, ".", "")), StringUtil.LTrim( ((edtavTotalbalance_Enabled!=0) ? context.localUtil.Format( AV6totalBalance, "ZZZZZZ9.99999999") : context.localUtil.Format( AV6totalBalance, "ZZZZZZ9.99999999"))), TempTags+" onchange=\""+"gx.num.valid_decimal( this, ',','.','8');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_decimal( this, ',','.','8');"+";gx.evt.onblur(this,8);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTotalbalance_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavTotalbalance_Enabled, 0, "text", "", 16, "chr", 1, "row", 16, 0, 0, 0, 1, -1, 0, true, "GxExplorer\\BTC", "right", false, "", "HLP_Wallet\\SendCoins.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+chkavSendallcoins_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            ...
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavSendallcoins_Internalname, StringUtil.BoolToStr( AV30sendAllCoins), "", "Send total balance", 1, chkavSendallcoins.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(12, this, 'true', 'false',"+"''"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,12);\"");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtavSendcoins_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtavSendto_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            ...
            GxWebStd.gx_single_line_edit( context, edtavSendto_Internalname, StringUtil.RTrim( AV8sendTo), StringUtil.RTrim( context.localUtil.Format( AV8sendTo, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,22);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavSendto_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavSendto_Enabled, 1, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 1, -1, -1, true, "GxExplorer\\scriptPubKey_address", "left", true, "", "HLP_Wallet\\SendCoins.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", cmbavUserfee.Visible, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+cmbavUserfee_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavUserfee, cmbavUserfee_Internalname, StringUtil.Trim( StringUtil.Str( AV20userFee, 16, 8)), 1, cmbavUserfee_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "decimal", "", cmbavUserfee.Visible, cmbavUserfee.Enabled, 1, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,27);\"", "", true, 1, "HLP_Wallet\\SendCoins.htm");
            cmbavUserfee.CurrentValue = StringUtil.Trim( StringUtil.Str( AV20userFee, 16, 8));
      ...
      {
         AV30sendAllCoins = StringUtil.StrToBool( StringUtil.BoolToStr( AV30sendAllCoins));
         AssignAttri("", false, "AV30sendAllCoins", AV30sendAllCoins);
         if ( cmbavUserfee.ItemCount > 0 )
         {
            AV20userFee = NumberUtil.Val( cmbavUserfee.getValidValue(StringUtil.Trim( StringUtil.Str( AV20userFee, 16, 8))), ".");
            AssignAttri("", false, "AV20userFee", StringUtil.LTrimStr( AV20userFee, 16, 8));
         }
         if ( context.isAjaxRequest( ) )
         {
            cmbavUserfee.CurrentValue = StringUtil.Trim( StringUtil.Str( AV20userFee, 16, 8));
      ...
      protected void STRUP0O0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV30sendAllCoins = StringUtil.StrToBool( cgiGet( chkavSendallcoins_Internalname));
            AssignAttri("", false, "AV30sendAllCoins", AV30sendAllCoins);
            ...
            AV20userFee = NumberUtil.Val( cgiGet( cmbavUserfee_Internalname), ".");
            AssignAttri("", false, "AV20userFee", StringUtil.LTrimStr( AV20userFee, 16, 8));
      ...
      protected void E120O2( )
      {
         /* 'Next' Routine */
         returnInSub = false;
         if ( ( AV7sendCoins >= AV6totalBalance ) && ! AV30sendAllCoins )
         {
         ...
         else
         {
            ...
            else
            {
               ...
               if ( String.IsNullOrEmpty(StringUtil.RTrim( AV10error)) )
               {
                  ...
                  GXt_char5 = AV10error;
                  new GeneXus.Programs.wallet.buildtransaction(context ).execute(  AV30sendAllCoins,  AV13transactionFee,  AV11wallet.gxTpr_Networktype,  AV12transactionsToSend,  AV7sendCoins,  AV8sendTo,  AV25changeTo, out  AV18virtualSize, out  AV19hexTransaction, out  GXt_char5) ;
                  AV10error = GXt_char5;
                  if ( String.IsNullOrEmpty(StringUtil.RTrim( AV10error)) )
                  {
                     GXt_char5 = AV10error;
                     new GeneXus.Programs.wallet.getestimatesmartfee(context ).execute(  AV18virtualSize,  60,  "economical", out  AV21economicalFee, out  AV28economicalBlocks, out  GXt_char5) ;
                     AV10error = GXt_char5;
                     if ( String.IsNullOrEmpty(StringUtil.RTrim( AV10error)) )
                     {
                        GXt_char5 = AV10error;
                        new GeneXus.Programs.wallet.getestimatesmartfee(context ).execute(  AV18virtualSize,  6,  "conservative", out  AV22standardFee, out  AV29standarBlocks, out  GXt_char5) ;
                        AV10error = GXt_char5;
                        if ( String.IsNullOrEmpty(StringUtil.RTrim( AV10error)) )
                        {
                           GXt_char5 = AV10error;
                           new GeneXus.Programs.wallet.getestimatesmartfee(context ).execute(  AV18virtualSize,  1,  "conservative", out  AV23fastestFee, out  AV27fastestBlocks, out  GXt_char5) ;
                           AV10error = GXt_char5;
                           if ( String.IsNullOrEmpty(StringUtil.RTrim( AV10error)) )
                           {
                              cmbavUserfee.addItem(StringUtil.Trim( StringUtil.Str( (decimal)(0), 16, 8)), "Select Estimated Transaction Fee", 0);
                              cmbavUserfee.addItem(StringUtil.Trim( StringUtil.Str( AV21economicalFee, 16, 8)), StringUtil.Trim( StringUtil.Str( AV21economicalFee, 16, 8))+" in about "+StringUtil.Str( (decimal)(AV28economicalBlocks), 4, 0)+" Blocks", 0);
                              cmbavUserfee.addItem(StringUtil.Trim( StringUtil.Str( AV22standardFee, 16, 8)), StringUtil.Trim( StringUtil.Str( AV22standardFee, 16, 8))+" in about "+StringUtil.Str( (decimal)(AV29standarBlocks), 4, 0)+" Blocks", 0);
                              cmbavUserfee.addItem(StringUtil.Trim( StringUtil.Str( AV23fastestFee, 16, 8)), StringUtil.Trim( StringUtil.Str( AV23fastestFee, 16, 8))+" in about "+StringUtil.Str( (decimal)(AV27fastestBlocks), 4, 0)+" Blocks", 0);
      ...
      protected void E130O2( )
      {
         /* 'Send Coins' Routine */
         returnInSub = false;
         if ( ! (Convert.ToDecimal(0)==AV20userFee) )
         {
            GXt_char5 = AV10error;
            new GeneXus.Programs.wallet.buildtransaction(context ).execute(  AV30sendAllCoins,  AV20userFee,  AV11wallet.gxTpr_Networktype,  AV12transactionsToSend,  AV7sendCoins,  AV8sendTo,  AV25changeTo, out  AV18virtualSize, out  AV19hexTransaction, out  GXt_char5) ;
            AV10error = GXt_char5;
            if ( String.IsNullOrEmpty(StringUtil.RTrim( AV10error)) )
            {
               GXt_char5 = AV10error;
               new GeneXus.Programs.wallet.sendrawtransaction(context ).execute(  AV19hexTransaction, out  GXt_char5) ;
               AV10error = GXt_char5;
               if ( String.IsNullOrEmpty(StringUtil.RTrim( AV10error)) )
               {
                  bttSendcoins_Visible = 0;
                  ...
                  GXt_char5 = AV10error;
                  new GeneXus.Programs.wallet.updatetransactionsaftercoinsent(context ).execute(  AV12transactionsToSend, out  GXt_char5) ;
                  AV10error = GXt_char5;
                  if ( String.IsNullOrEmpty(StringUtil.RTrim( AV10error)) )
                  {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2022121113185176", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wallet/sendcoins.js", "?2022121113185176", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV30sendAllCoins',fld:'vSENDALLCOINS',pic:''},{av:'AV11wallet',fld:'vWALLET',pic:'',hsh:true},{av:'AV6totalBalance',fld:'vTOTALBALANCE',pic:'ZZZZZZ9.99999999',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'NEXT'","{handler:'E120O2',iparms:[{av:'AV7sendCoins',fld:'vSENDCOINS',pic:'ZZZZZZ9.99999999'},{av:'AV6totalBalance',fld:'vTOTALBALANCE',pic:'ZZZZZZ9.99999999',hsh:true},{av:'AV30sendAllCoins',fld:'vSENDALLCOINS',pic:''},{av:'AV8sendTo',fld:'vSENDTO',pic:''},{av:'AV11wallet',fld:'vWALLET',pic:'',hsh:true},{av:'cmbavUserfee'},{av:'AV20userFee',fld:'vUSERFEE',pic:'ZZZZZZ9.99999999'}]");
         setEventMetadata("'NEXT'",",oparms:[{av:'edtavSendcoins_Enabled',ctrl:'vSENDCOINS',prop:'Enabled'},{av:'edtavSendto_Enabled',ctrl:'vSENDTO',prop:'Enabled'},{ctrl:'NEXT',prop:'Visible'},{ctrl:'SENDCOINS',prop:'Visible'},{av:'AV12transactionsToSend',fld:'vTRANSACTIONSTOSEND',pic:''},{av:'AV25changeTo',fld:'vCHANGETO',pic:''},{av:'cmbavUserfee'},{av:'AV20userFee',fld:'vUSERFEE',pic:'ZZZZZZ9.99999999'}]}");
         setEventMetadata("'SEND COINS'","{handler:'E130O2',iparms:[{av:'cmbavUserfee'},{av:'AV20userFee',fld:'vUSERFEE',pic:'ZZZZZZ9.99999999'},{av:'AV30sendAllCoins',fld:'vSENDALLCOINS',pic:''},{av:'AV11wallet',fld:'vWALLET',pic:'',hsh:true},{av:'AV12transactionsToSend',fld:'vTRANSACTIONSTOSEND',pic:''},{av:'AV7sendCoins',fld:'vSENDCOINS',pic:'ZZZZZZ9.99999999'},{av:'AV8sendTo',fld:'vSENDTO',pic:''},{av:'AV25changeTo',fld:'vCHANGETO',pic:''}]");
         setEventMetadata("'SEND COINS'",",oparms:[{ctrl:'SENDCOINS',prop:'Visible'},{av:'cmbavUserfee'}]}");
      ...
      private short AV28economicalBlocks ;
      private short AV29standarBlocks ;
      private short AV27fastestBlocks ;
      ...
      private int idxLst ;
      private long AV18virtualSize ;
      private decimal AV6totalBalance ;
      private decimal AV7sendCoins ;
      private decimal AV20userFee ;
      private decimal GXt_decimal4 ;
      private decimal AV13transactionFee ;
      private decimal AV21economicalFee ;
      private decimal AV22standardFee ;
      private decimal AV23fastestFee ;
      ...
      private bool wbLoad ;
      private bool AV30sendAllCoins ;
      private bool Rfr0gs ;
      private bool wbErr ;
      private bool gxdyncontrolsrefreshing ;
      private bool returnInSub ;
      private string AV19hexTransaction ;
