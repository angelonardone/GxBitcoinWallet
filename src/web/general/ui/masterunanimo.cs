...
namespace GeneXus.Programs.general.ui {
   public class masterunanimo : GXMasterPage
   {
      public masterunanimo( )
      {
      ...
      public masterunanimo( IGxContext context )
      {
      ...
      protected void RenderHtmlCloseForm0S2( )
      {
         ...
         context.AddJavascriptSource("general/ui/masterunanimo.js", "?20248815202038", false, true);
      ...
      {
         return "General.UI.MasterUnanimo" ;
      }

      public override string GetPgmdesc( )
      {
         return "Master Unanimo" ;
      }
      ...
      protected void WB0S0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-grow:1;min-height:20px;", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGxbitcoinwallet_Internalname, "GxBitcoinWallet", "", "", lblGxbitcoinwallet_Jsonclick, "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "header__title", 0, "", 1, 1, 0, 0, "HLP_General/UI/MasterUnanimo.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divContent_Internalname, 1, 0, "px", 0, "px", "ContainerFluid", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?20248815202042", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("general/ui/masterunanimo.js", "?20248815202042", false, true);
         }
      ...
      {
         lblGxbitcoinwallet_Internalname = "GXBITCOINWALLET_MPAGE";
      ...
      private string lblGxbitcoinwallet_Internalname ;
      private string lblGxbitcoinwallet_Jsonclick ;
